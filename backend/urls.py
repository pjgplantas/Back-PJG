...
from pjgplantas.views import BoletoViewSet, CartaoViewSet, ComentarioViewSet, ItensCarrinhoViewSet, MidiaViewSet, PedidoViewSet, PixViewSet, PlantaViewSet, TipoUsuarioViewSet, UsuarioViewSet

router = DefaultRouter()
router.register(r'tiposusuarios', TipoUsuarioViewSet)
