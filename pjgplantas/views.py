...
from pjgplantas.serializers import BoletoSerializer, CartaoSerializer, ComentarioSerializer, ItensCarrinhoSerializer, MidiaSerializer, PedidoSerializer, PixSerializer, PlantaSerializer, TipoUsuarioSerializer, UsuarioSerializer
